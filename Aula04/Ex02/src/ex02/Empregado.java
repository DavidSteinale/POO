...
public class Empregado extends Pessoa {
    ...
    private final int VENDA = 2;
    private final int ESTOQUE = 3;

    //CONSTRUTOR HERDADO DA CLASSE PESSOA E COM SEU ATRIBUTOS PARTICULARES
    public Empregado(String nome, String endereco, String telefone, int codigoSetor, BigDecimal salarioBase, BigDecimal imposto, TipoJornadaEmpregado turno) {
...
//METODOS MODIFICADORES
    ...
    public TipoJornadaEmpregado getTurno() {
        return turno;
    }

    public void setTurno(TipoJornadaEmpregado turno) {
        this.turno = turno;
    }
